...
@ActiveProfiles("test")
public class StatusControllerIntTest {
    ...
    public void should_returnList() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/status")) // Executa
        ...
        //.andExpect(MockMvcResultMatchers.jsonPath("$[0].NomeStatus").value("status"));
